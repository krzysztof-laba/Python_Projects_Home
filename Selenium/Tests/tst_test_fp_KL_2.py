...
class TestSalaryCalculatorIe(TestSalaryCalculator):
    path_ie_driver = "C:\Python-geckodriver\Ie_driver_64\IEDriverServer.exe"

    @classmethod
    def setUpClass(cls):
        cls.driver = webdriver.Ie(executable_path=cls.path_ie_driver)

    def get_driver(self):
        return self.driver

class TestSalaryCalculatorFirefox(TestSalaryCalculator):

    path_firefox_driver = "C:\Python-geckodriver\geckodriver.exe"

    @classmethod
    def setUpClass(cls):
        cls.driver = webdriver.Firefox(executable_path=cls.path_firefox_driver)
